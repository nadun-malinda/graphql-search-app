...
export function LoadingSkeleton({
  ...
  return (
    <>
      <div className="relative animate-pulse flex justify-end w-full mb-6">
        <div className="aspect-square bg-react-dark border border-gray-500 w-20 h-10 rounded-full flex justify-center items-center">
          <p className="h-2 w-1/2 rounded-lg bg-gray-400" />
        </div>
      </div>
      <ul
